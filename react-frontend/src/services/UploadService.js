...
export default function UploadService({ serviceName, user, onUploadComplete, disabled }) {
    ...
    const _getSchema = async (serviceName) => {
        const _schema = await props.getSchema(serviceName);
    ...
    const sendFailedRecordEmail = async (failedRecords) => {
        ...
        reader.onloadend = async function () {
            ...
            console.debug('upload service failedRecordDetails : ', failedRecordDetails);
            ...
            try {
                ...
                console.debug('Failed records email sent successfully with attachment.');
            } catch (error) {
