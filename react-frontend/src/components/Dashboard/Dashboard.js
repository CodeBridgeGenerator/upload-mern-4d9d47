...
import CompanyServices from './TabView/seviceTables/MyAppServices';
            ...
            try {
                ...
                if (selectedProfile?.preferences) {
                    ...
                    const uniqueRecentItems = recent
                        .reverse()
                        .filter((item, index, self) => self.findIndex((i) => i.url === item.url) === index && item.mainMenu === 'student')
                        .slice(0, 3)
                        .map((item) => ({
                            text: item.label,
                            subtext: item.name,
                    ...
                    const filteredPinnedItems = favourites
                        .filter((item) => item.mainMenu === 'student')
                        .slice(-3)
                        .map((item) => ({
                            text: item.label,
            ...
            <div className="p-2 md:p-4">
                ...
                <div className="mb-2 flex justify-content-between align-items-center">
                    <div className="mb-4 flex justify-content-between align-items-center">
                        <span className="text-900 font-medium text-3xl m-0.5">Dashboard</span>
                    </div>
                ...
                <div className="surface-border border-round surface-card">
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-4">
                            <TotalComponent TotalComp={'Total Students'} isEdit={isEdit} total={totalCompanies} />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid">
                        ...
                        {/* Bar Chart */}
                        <div className="col-12 md:col-4 mb-3">
                            <CompanyBarChart total={'Total Companies'} isEdit={isEdit} />
                        </div>
                        {/* <div className="col-12 md:col-8 mb-3 relative">
              <MultipleChart />
            </div> */}
