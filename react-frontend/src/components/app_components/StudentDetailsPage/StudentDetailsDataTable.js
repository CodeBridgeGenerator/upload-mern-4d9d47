...
<Column field="stuImage" header="Stu Image" body={file_uploadTemplate1} filter={selectedFilterFields.includes("stuImage")} hidden={selectedHideFields?.includes("stuImage")}  sortable style={{ minWidth: "8rem" }} />
