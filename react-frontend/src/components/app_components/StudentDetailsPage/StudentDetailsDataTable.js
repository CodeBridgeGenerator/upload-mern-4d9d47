...
<Column field="image" header="Image" body={file_uploadTemplate1} filter={selectedFilterFields.includes("image")} hidden={selectedHideFields?.includes("image")}  sortable style={{ minWidth: "8rem" }} />
