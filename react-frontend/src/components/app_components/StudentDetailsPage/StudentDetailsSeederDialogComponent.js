...
import seederData from "./studentDetails.seeder.json";
...
const StudentDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StudentDetailsSeederDialogComponent);
