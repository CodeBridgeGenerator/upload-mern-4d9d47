...
import seederData from "./tickets.seeder.json";
...
const TicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TicketsSeederDialogComponent);
