            ...
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="staffinfo-edit-dialog-component">
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="empno" className="w-full mb-3 p-inputtext-sm" value={_entity?.empno} useGrouping={false} onChange={(e) => setValByKey('empno', e.value)} />
                    </span>
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="compcode" className="w-full mb-3 p-inputtext-sm" value={_entity?.compcode} useGrouping={false} onChange={(e) => setValByKey('compcode', e.value)} />
                    </span>
                    <small className="p-error">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="sectcode" className="w-full mb-3 p-inputtext-sm" value={_entity?.sectcode} useGrouping={false} onChange={(e) => setValByKey('sectcode', e.value)} />
                    </span>
                    <small className="p-error">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="datejoin" className="w-full mb-3 p-inputtext-sm" value={_entity?.datejoin} useGrouping={false} onChange={(e) => setValByKey('datejoin', e.value)} />
                    </span>
                    <small className="p-error">
