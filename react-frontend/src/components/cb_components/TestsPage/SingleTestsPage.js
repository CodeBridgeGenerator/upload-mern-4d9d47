    ...
    return (
        <ProjectLayout>
            <div className="col-12 flex flex-column align-items-center">
                <div className="col-12">
                    ...
                    <div className="card w-full">
                        <div className="grid ">
                            ...
                            <div className="col-12 md:col-6 lg:col-3 mb-10">
                                <label className="text-sm text-gray-600">Passed</label>
                ...
                <CommentsSection recordId={urlParams.singleTestsId} user={props.user} alert={props.alert} serviceName="tests" />
