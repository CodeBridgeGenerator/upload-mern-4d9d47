            ...
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="tests-edit-dialog-component">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="passed" className="w-full mb-3" value={_entity?.passed} useGrouping={false} onChange={(e) => setValByKey('passed', e.value)} />
                    </span>
                    <small className="p-error">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="failed" className="w-full mb-3" value={_entity?.failed} useGrouping={false} onChange={(e) => setValByKey('failed', e.value)} />
                    </span>
                    <small className="p-error">
