    ...
    useEffect(() => {
        client
            ...
            .then((res) => {
                ...
                const filteredResults = results.filter((profile) => profile.userId?._id === props.user._id);
        ...
        return (
            <div className={`flex ${className} max-md:max-w-full`}>
                {items.map((item, index) => (
                    <div key={index} className="flex flex-col flex-1 shrink basis-0 min-w-[180px] max-md:max-w-full">
                ...
                return (
                  ...
                  Default
                        ...
                        <div className="flex flex-col mt-5 w-full  tracking-wide max-md:max-w-full">
                            <ProfileSection items={bioAndSkills} className="flex-wrap gap-5 items-start w-full" />
